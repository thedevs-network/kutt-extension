...
document.addEventListener('DOMContentLoaded', function () {
  ...
  webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default.a.storage.local.get(['key', 'pwd']).then(function (result) {
    // to strings
    var API_KEY = "".concat(result.key),
        pwd = "".concat(result.pwd);
...
var saveData = function saveData() {
  var API_KEY = document.getElementById('api__key--value').value;
  ...
  webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default.a.storage.local.set({
    key: API_KEY,
    pwd: password
  }).then(function () {//    console.log('API Key set to ' + API_KEY);
  }); // Saved Alert

  var element = document.querySelector('.saved__alert');
...
document.getElementById('password__view--checkbox').addEventListener('click', function () {
