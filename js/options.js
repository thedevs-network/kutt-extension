...
let saveData = () => {
  ...
  if (!password) {} //     console.log("No password Set");
  // store value locally


  _scripts_vendor_browser_polyfill__WEBPACK_IMPORTED_MODULE_0___default.a.storage.local.set({
    key: API_KEY,
    pwd: password
  }).then(() => {//    console.log('API Key set to ' + API_KEY);
  }); // Saved Alert
