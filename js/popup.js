...
/* harmony import */ var webextension_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(24);
/* harmony import */ var webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(webextension_polyfill__WEBPACK_IMPORTED_MODULE_0__);

var shortUrl;
document.addEventListener('DOMContentLoaded', function () {
  // 1. Initialize
  webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default.a.tabs.query({
    'active': true,
    ...
    longUrl = tabs[0].url;
    start = longUrl.substr(0, 6); // i) Get api key from options page

    webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default.a.storage.local.get(['key', 'pwd']).then(function (result) {
      API_key = result.key;
      password = result.pwd;
      ...
      if (start !== 'chrome' && API_key !== '' && API_key !== undefined) {
        ...
        webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default.a.runtime.sendMessage({
          ...
          pageUrl: "".concat(longUrl),
          password: "".concat(password)
        }).then(function (response) {
          // store the shortened link
          shortUrl = response.shortUrl;
          console.log(shortUrl); // invalid response
          ...
          if (shortUrl === undefined) {
            ...
            document.getElementById('qr_code').src = "".concat(qrcode__src).concat(shortUrl); // show buttons                        
  ...
  document.getElementById('button__copy').addEventListener("click", function () {
    try {
      var copyTextarea = "".concat(shortUrl);
  ...
  document.getElementById('button__details').addEventListener('click', function () {
    var win = window.open("".concat(shortUrl, "+"), '_blank');
    win.focus();
  }); // 4. QR Code

  document.getElementById('button__qrcode').addEventListener('click', function () {
